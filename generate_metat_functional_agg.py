...
class MetatranscriptomeFuncAgg(Aggregator):
    """
    Metatranscriptome Aggregator class
    ...
    def __init__(self):
        super().__init__()
        self.aggregation_filter = '{"was_generated_by":{"$regex":"^nmdc:wfmtan"}}'
        self.workflow_filter = '{"type":"nmdc:MetatranscriptomeAnnotation"}'
